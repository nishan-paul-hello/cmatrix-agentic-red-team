                ...
                <TableRow key={item.prompt_id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium truncate max-w-[180px]" title={item.conversation_name}>
                  ...
                  <TableCell className="max-w-xs">
                    <div className="truncate text-muted-foreground" title={item.response || "No response"}>
