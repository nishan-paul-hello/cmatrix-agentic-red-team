...
export function ConversationProvider({ children }: { children: React.ReactNode }) {
  ...
  // Update conversation
  const updateConversation = useCallback(async (id: number, name: string) => {
    try {
      setError(null);
  ...
  const loadConversationHistory = useCallback(async (id: number): Promise<ConversationWithHistory> => {
    try {
      setError(null);
