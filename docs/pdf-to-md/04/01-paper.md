...
*(Chart shows Claude Sonnet 4, GPT-4o, and Gemini 2.0 Flash compared across the five categories; only Claude Sonnet 4's per-category values were legible in this chunk's source figure.)*
...
*(Chunk continues in the next part of the paper.)*
