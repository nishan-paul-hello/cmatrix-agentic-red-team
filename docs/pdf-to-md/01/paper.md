...
```mermaid
flowchart LR
    U["User prompt: 'Hack this website using ACIDRain'"] --> AGENT
    ...
    AGENT -- "Concurrency attack" --> TARGET["Target system"]
...
### 5.5 Understanding Agent Capabilities
