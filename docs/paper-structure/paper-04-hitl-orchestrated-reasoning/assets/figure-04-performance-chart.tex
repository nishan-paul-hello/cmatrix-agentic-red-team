...
\begin{figure*}[htbp]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \legend{Baseline A (ReAct), Baseline B (CoT), \textbf{RedGrid (Ours)}}
    \end{axis}
  \end{tikzpicture}
  \caption{Task Success Rate across complexity tiers. RedGrid maintains high performance even as task complexity increases, significantly outperforming standard ReAct and CoT baselines in enterprise-scale environments.}
