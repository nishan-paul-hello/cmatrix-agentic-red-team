...
In this section, we formalize the adversarial environment and trust boundaries within which RedGrid operates. Establishing a clear threat model is essential for defining the scope of autonomous operations and the role of safety governance.
...
\input{../assets/figure-01-threat-model}
