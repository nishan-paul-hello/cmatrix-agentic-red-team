...
- `docs/paper-research/paper-04-agent-reasoning/assets/table-04-planned-evaluation-results.tex`: Final results.
- `docs/paper-research/paper-04-agent-reasoning/assets/table-05-case-study-attack-chain.tex`: Case study.
