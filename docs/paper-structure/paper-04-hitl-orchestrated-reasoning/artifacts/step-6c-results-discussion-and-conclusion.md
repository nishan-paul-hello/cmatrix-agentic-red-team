...
- `docs/paper-research/paper-04-agent-reasoning/content/evaluation.tex`: Results source.
- `docs/paper-research/paper-04-agent-reasoning/content/discussion.tex`: Discussion source.
- `docs/paper-research/paper-04-agent-reasoning/content/conclusion.tex`: Conclusion source.
