...
- `docs/paper-research/paper-04-agent-reasoning/content/related_work.tex`: Related work source.
- `docs/paper-research/paper-04-agent-reasoning/content/methodology.tex`: Methodology source.
