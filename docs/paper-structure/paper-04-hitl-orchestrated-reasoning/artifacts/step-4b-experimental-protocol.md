...
- `docs/paper-research/paper-04-agent-reasoning/assets/table-02-experimental-benchmarks.tex`: Dataset table.
- `docs/paper-research/paper-04-agent-reasoning/assets/table-03-metrics-definitions.tex`: Metrics table.
