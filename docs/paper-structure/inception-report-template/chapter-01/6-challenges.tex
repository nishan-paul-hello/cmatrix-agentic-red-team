...
\begin{enumerate}
	...
	\item \textbf{Cost is a moving target.} Whatever cost-per-exploit figures are eventually reported, they reflect a specific model and pricing at a specific moment, and that needs to be stated explicitly rather than presenting cost as a fixed property of the approach.
