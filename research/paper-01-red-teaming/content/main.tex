...
The remainder of this paper is organized as follows. Section II reviews the related work in autonomous penetration testing and LLM safety. Section III formalizes our threat model and safety properties. Section IV details the CMatrix system architecture, including the supervisor routing and multi-agent coordination. Section V describes our hierarchical HITL safety framework and checkpointing mechanism. Section VI presents our agentic RAG memory pipeline. Section VII details our reasoning and self-reflection loops. Section VIII presents our experimental evaluation and results. Section IX discusses the implications and limitations of our findings, and Section X concludes the paper.
