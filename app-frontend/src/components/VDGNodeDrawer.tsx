                    ...
                    <div className="grid grid-cols-2 gap-0 overflow-hidden rounded-[2px] border-[1px] border-solid border-[var(--color-hex-1e1e1e)]">
                        {[
                            ...
                            <div
                                ...
                                style={{
                                    borderRight:
                                        i % 2 === 0 ? "1px solid var(--color-hex-1a1a1a)" : "none",
                                    borderBottom:
                                        i < 6 ? "1px solid var(--color-hex-1a1a1a)" : "none",
                                    background:
                                        i % 2 === 0
                        ...
                        {detail.enables.length === 0 ? (
                            ...
                            detail.enables.map((id) => (
                                <div key={id} className="flex items-center gap-2">
                                    <span className="text-[9px] text-[var(--color-hex-e31b23)]">
                                        →
                                    </span>
                                ...
                                <div className="flex shrink-0 flex-col items-center">
                                    <div
                                        ...
                                        style={{
                                            ...
                                            background:
                                                i === a.length - 1 ? t.color : "transparent",
                                        }}
                                    />
                                    {i < a.length - 1 && (
