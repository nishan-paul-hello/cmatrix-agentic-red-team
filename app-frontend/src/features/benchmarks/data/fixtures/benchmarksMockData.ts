...
export const TIER_META: Record<BenchTier, { label: string; color: string; axisNote?: string }> = {
    TIER0_SANDBOX: { label: "TIER 0 — SANDBOX", color: "var(--color-zinc-600)" },
    TIER0B_HPTSA: { label: "TIER 0b — HPTSA", color: "var(--color-zinc-700)" },
    TIER1_PENTESTEVAL: { label: "TIER 1 — PENTESTEVAL", color: "var(--warning)" },
    TIER2_CVEBENCH: { label: "TIER 2 — CVE-BENCH", color: "var(--primary)" },
    TIER2B_CROSSBENCH: { label: "TIER 2b — CROSS-BENCH", color: "var(--border)" },
    TIER3_PREDIQL: {
    ...
    TIER5_BOUNTYBENCH: { label: "TIER 5 — BOUNTYBENCH", color: "var(--destructive)" },
    TIER6_LIVECOMP: { label: "TIER 6 — LIVE COMP", color: "var(--border)" },
};
