            ...
            {f.path.map((node, i) => (
                <div key={node} className="mb-[0px] flex gap-3">
                    <div className="flex w-[24px] shrink-0 flex-col items-center">
                        <div className="mt-[3px] h-[8px] w-[8px] shrink-0 rounded-[1px] bg-[var(--color-brand)]" />
                        {i < f.path.length - 1 && (
                            <div
                    ...
                    >
                        <div className="mb-[2px] text-lg font-bold tracking-tight text-[var(--color-hex-a0a0a0)]">
                            {node}
                        </div>
