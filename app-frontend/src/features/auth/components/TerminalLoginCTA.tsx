...
export function TerminalLoginCTA({ originalText, className, showArrow, icon }: TerminalLoginCTAProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger render={<TerminalCTA className={className} originalText={originalText} />}>
